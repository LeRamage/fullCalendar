////////////////////////////////////////
// Modules de creation des défaults  //
///////////////////////////////////////
...
function createEvent(classNames,start,end,resourceId){
  let event = {
...
// --------- création d'un évenement avec extendedProps --------- //
function createEventWithExtProp(classNames,start,end,resourceId,extendedProps){
  let event = {
      classNames: classNames,
      start: start,
      end: end,
